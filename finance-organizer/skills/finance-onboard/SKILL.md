...
1. **Company structure → sets of books.** How many "sets of books" do they keep, and what are they (business entity, personal, spouse, etc.)? For each: a label, business vs personal, and fiscal year-end (businesses vary; personal is usually Dec 31). This becomes `sets_of_books[]`. Most small operators have at least a business + a personal set, and these *overlap* — call that out as normal.
